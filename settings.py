...
class RuntimeSettings:
    ...
    def summary(self) -> str:
        return (
            f"regions={self.regions} max_events={self.max_events} odds_provider={self.odds_provider} only_active_tennis={self.only_active_tennis} bankroll={self.bankroll} "
...
def load_runtime_settings() -> RuntimeSettings:
    ...
    return RuntimeSettings(
        ...
        odds_provider=os.getenv("ODDS_PROVIDER", "theodds").strip().lower(),
